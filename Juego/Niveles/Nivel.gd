...
##atributos export
export var explosion_player:PackedScene=null
export var meteorito:PackedScene=null
export var explosion_meteorito:PackedScene=null
export var sector_meteoritos:PackedScene=null
export var tiempo_transicion_camara:float=2.5
...
func transicion_camaras(desde:Vector2,
	hasta:Vector2,
